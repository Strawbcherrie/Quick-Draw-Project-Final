...
function setup(){
    ...
    //canvas.mouseRelease(classifyCanvas()) why not like this?; and this?
}

quick_draw_data_set=["line","stitches","The_Eiffel_Tower"];
...
// why cnnot we write single inverted commas up ?
...
function classifyCanvas(){
    ...
    // first we used to type got results why not now?
}
...
function gotResult(error, results){
    if(error){
        ...
        document.getElementById("label").innerHTML = "You have drawn : " + drawn_sketch;
...
// Timer need not be an array here. timer_counter = 0; timer_check = ""; drawn_sketch = ""; answer_holder = ""; score = 0;
